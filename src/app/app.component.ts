...
import { IFormField } from './interfaces/app.interface';
import { AppService } from './services/app.service';
import { DataValidator } from './tools/data.validation';
...
export class AppComponent implements OnInit {
  title = 'angular-dynamic-form-controls-validation';

  //FORM DECLARATION
  formDemo: FormGroup = this.fb.group({});
  formModel: IFormField = <IFormField>{};
  lstForm: IFormField[] = [];
  ...
  setForm() {
    ...
    //remote validation for check is username exists or not
    let _un = <IFormField>{
      label: 'User Name',
      fieldName: 'userName',
      fieldType: 'text',
